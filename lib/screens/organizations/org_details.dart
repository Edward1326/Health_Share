    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
            ...
            Container(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [
                      _getStatusColor(_membershipStatus).withOpacity(0.05),
                      _getStatusColor(_membershipStatus).withOpacity(0.1),
                    ],
                  ),
                  borderRadius: BorderRadius.circular(16),
                  border: Border.all(
                    color: _getStatusColor(_membershipStatus).withOpacity(0.2),
                    width: 1,
                  ),
                ),
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Icon(
                        _membershipStatus == 'accepted' ||
                                _membershipStatus == 'active'
                            ? Icons.verified_rounded
                            : _membershipStatus == 'pending'
                            ? Icons.schedule_rounded
                            : Icons.cancel_rounded,
                        color: _getStatusColor(_membershipStatus),
                        size: 24,
                      ),
                    ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            _getStatusText(_membershipStatus),
                            style: TextStyle(
                              fontSize: 16,
                              fontWeight: FontWeight.w600,
                              color: _getStatusColor(_membershipStatus),
          ...
          // Join Button
          if (!_hasJoined ||
              _membershipStatus == 'declined' ||
              _membershipStatus == 'rejected')
            Container(
              height: 60,
              decoration: BoxDecoration(
                gradient: const LinearGradient(
