import 'dart:convert';
import 'package:health_share/services/hive_service/verify_hive/hive_fetch.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

/// Business logic for validating file integrity before decryption
/// Compares blockchain data with Supabase Hive_Logs records
class HiveCompareService {
  ...
  static Future<bool> verifyBeforeDecryption({
    ...
    try {
      ...
      if (effectiveTrxId != null && effectiveTrxId.isNotEmpty) {
        ...
        try {
          final transaction = await HiveFetch.getTransaction(effectiveTrxId);
      ...
      if (blockchainFileHash == null) {
        ...
        try {
          final accountHistory = await HiveFetch.getAccountHistory(
            username,
  ...
  static Future<Map<String, dynamic>> getVerificationStatus({
    ...
    try {
      ...
      status['blockchain_connected'] = await HiveFetch.testConnection();
